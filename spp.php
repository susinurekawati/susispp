    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="edit_spp.php?id spp=<?php echo $row['id_spp']; ?>">Edit</a> |
              <a href="proses_hapusspp.php?id_spp=<?php echo $row['id_spp']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
